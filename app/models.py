...
class Result(db.Model):
    ...
    PR1 = db.Column(db.Integer())
    PR2 = db.Column(db.Integer())
    PR3 = db.Column(db.Integer())
    PR4 = db.Column(db.Integer())
    PR5 = db.Column(db.Integer())
    PR6 = db.Column(db.Integer())
    PR7 = db.Column(db.Float())
